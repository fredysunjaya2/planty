            ...
            <div class="sub d-flex row">
                ...
                <div class="disease col-12 d-flex row mt-3 pb-5">
                    ...
                    <div class="disease-list d-flex align-items-center justify-content-around col-10">
                        <x-disease-card href="disease1" number="1"
                            hoverImage="{{ asset('/assets/disease/disease1.jpg') }}">Downy Mildew</x-disease-card>
                        <x-disease-card href="disease2" number="2"
                            hoverImage="{{ asset('/assets/disease/disease2.jpg') }}">Powdery Mildew</x-disease-card>
                        <x-disease-card href="disease3" number="3"
                            hoverImage="{{ asset('/assets/disease/disease3.jpg') }}">Root <br> Rot</x-disease-card>
                        <x-disease-card href="disease4" number="4"
                            hoverImage="{{ asset('/assets/disease/disease4.jpg') }}">Leaf <br> Spot</x-disease-card>
                    </div>
                    <div class="col-1"></div>
                </div>
            </div>
