...
<body>
    <div class="container-fluid m-0 p-0">
        <div class="row col-12">
                      ...
                      <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade ms-5 me-5" id="nav-paymentMethod" role="tabpanel" aria-labelledby="nav-paymentMethod-tab" tabindex="0">
                            <div class="e-money mt-4">
                                <h6 class="planty-heading-4">E-Money</h6>
                            </div>
                            <div class="e-money-method mb-5">
                                <ul class="list-group gap-3">
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-row-reverse" style="border-radius: 0.625rem; border: 1px solid #618264;">
                                      <input class="form-check-input me-1" type="radio" name="listGroupRadio" value="" id="firstRadio" style="border-color: #618264;" checked>
                                      <label class="form-check-label planty-heading-4" for="firstRadio">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-row-reverse" style="border-radius: 0.625rem; border: 1px solid #618264;">
                                      ...
                                      <label class="form-check-label planty-heading-4" for="secondRadio">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-row-reverse" style="border-radius: 0.625rem; border: 1px solid #618264;">
                                        ...
                                        <label class="form-check-label planty-heading-4" for="thirdRadio">
                            ...
                            <div class="credit">
                                <h6 class="planty-heading-4">Credit / Debit Card</h6>
                            </div>
                            <div class="credit-method">
                                <ul class="list-group">
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-row-reverse" style="border-radius: 0.625rem; border: 1px solid #618264;">
                                        ...
                                        <label class="form-check-label planty-heading-4" for="creditRadio">
                            ...
                            <div class="payment-btn d-flex justify-content-center mt-5">
                                <button type="button" class="btn btn-success planty-heading-4 text-white" style="width: 7.0625rem; height: 3.125rem; border-radius: 0.625rem; background: #618264;">Pay</button>
                            </div>
                        </div>
                      </div>
                </div>
            ...
            <div class="col-3 mt-5 mb-5 p-0 pt-3">
