...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <link rel="stylesheet" href="{{ asset('/css/donts.css') }}">
...
<body>
    ...
    <div class="page-container container-fluid p-0 d-flex row m-0 p-0">
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="jumbotron-container container text-center text-white justify-content-between d-flex flex-column"
                style="height: 60%">
                <h1 class="planty-heading-1 display-4"
                    style="color: white; text-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">Don'ts</h1>
                <div class="mistakes">
                    ...
                    <div class="mistake-container col d-flex justify-content-evenly align-items-center p-0 m-0">
                        <x-mistake-card mistakeLogo="{{ asset('/assets/donts/neglectingIngredients.png') }}"
                            href="neglecting-ingredients">Neglecting
                            ingredients</x-mistake-card>
                        <x-mistake-card mistakeLogo="{{ asset('/assets/donts/overwateringPlants.png') }}"
                            href="overwatering-plants">Overwatering plants</x-mistake-card>
                        <x-mistake-card mistakeLogo="{{ asset('/assets/donts/ignoringLightRequirement.png') }}"
                            href="ignoring-light-requirements">Ignoring light requirement</x-mistake-card>
                    </div>
                    {{-- END START COMPONENT --}}
                </div>
            </div>
