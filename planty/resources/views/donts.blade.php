...
<body>
    ...
    <div class="page-container container-fluid p-0">
        ...
        <div class="content-container" style="height: 100%">
            <div id="neglecting-ingredients" class="d-flex flex-row justify-content-center align-items-center my-5 py-5">
            ...
            <div id="overwatering-plants" class="d-flex flex-row-reverse justify-content-center align-items-center my-5 py-5" >
            ...
            <div id="ignoring-light-requirements" class="d-flex flex-row justify-content-center align-items-center my-5 py-5">
