            ...
            <div class="col-5 plan-information-1 p-0 m-0">
                <div class="subs-list px-5">
                    <div class="plan-information-title-1">
                        <p class="planty-text-sentence ">start your plant journey with easy- <br> to-care-for plants and comprehensive guidance.</p>
                    </div>
            ...
            <div class="col-5 plan-information-2 p-0 m-0">
                <div class="subs-list px-5">
                    <div class="plan-information-title-2">
                        <p class="planty-text-sentence ">expand your collection and knowledge with a <br> variety of plants and advanced resources.</p>
                    </div>
