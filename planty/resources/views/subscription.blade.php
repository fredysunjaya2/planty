...
<body>
    ...
    <div class="container-fluid content subscription-container">
        ...
        <div class="container position-relative plan-content">
            ...
            <div class="row position-relative plan-information-content ">
                ...
                <div class="col-5 plan-information-1 p-0 m-0">
                    <div class="subs-list px-5">
                        <div class="plan-information-title-1">
                            <p class="planty-text-sentence ">start your plant journey with easy- <br> to-care-for plants
                ...
                <div class="col-5 plan-information-2 p-0 m-0">
                    <div class="subs-list px-5">
                        <div class="plan-information-title-2">
                            <p class="planty-text-sentence ">expand your collection and knowledge with a <br> variety of
                                plants and advanced resources.</p>
                        </div>
                        ...
                        <ul class="planty-text-sentence ">
                            ...
                            <li>&#10004; Seasonal Tips</li>
                            <li>&#10004; Surprise Gifts: rare plant seeds, stylish plant pots, or unique accessories.
                            </li>
                        </ul>
